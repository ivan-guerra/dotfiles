...
in
{
  programs.fish = {
    ...
    shellAliases = {
      ...
      telekrates_tunnel = "${pkgs.openssh}/bin/ssh -L 5902:localhost:5902 -p 54447 -i $HOME/.ssh/rsbot ieg@10.0.0.44";
      aldur_tunnel = "${pkgs.openssh}/bin/ssh -L 5903:localhost:5903 -p 54448 -i $HOME/.ssh/rsbot aldur07@10.0.0.119";
    };
